...
public class CookieContext {
	...
	public void setXsrfToken(String cookie){
		store.put(XSRF_TOKEN, cookie);
	}
	...
	public String getXsrfTokenFormattedCookie(){
		String cookieValue = store.get(XSRF_TOKEN);
		if (cookieValue==null){
			return XSRF_TOKEN + "=";
		}
		return XSRF_TOKEN + "=" +  store.get(XSRF_TOKEN);
	}
